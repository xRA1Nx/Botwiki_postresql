root_wiki_url = "https://ru.wikipedia.org/"
...
/parse - актуализировать базу данных,
/cities - список городов,
или укажите название города для получения информации по нему
""",
    "parse": "данные актуализированы",
}
